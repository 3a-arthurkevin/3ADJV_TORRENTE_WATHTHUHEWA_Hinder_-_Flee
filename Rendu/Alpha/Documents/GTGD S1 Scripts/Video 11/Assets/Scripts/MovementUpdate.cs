...
public class MovementUpdate : MonoBehaviour {
	...
	void Start () 
	{
		if(networkView.isMine == true)
		{
			...
			networkView.RPC("updateMovement", RPCMode.OthersBuffered,
			                myTransform.position, myTransform.rotation, myTransform.localScale);
		}
	...
	//Ensures that the player's position, rotation, and scale are kept
	//up to date across the network.
