...
/// 
/// The PlayerAsksServerToPlaceAirBlock script accesses this script.
/// 
/// The AirBlockGuide script accesses this script.
/// </summary>
...
public class ChangeBuildOption : MonoBehaviour {
	...
	void selectedBuildOptionWindow (int windowID)
	{
		...
		if(buildOption == ChangeBuildOption.State.airBlock)
		{
			GUILayout.Label(airBlockTex, GUILayout.Width(iconWidth), GUILayout.Height(iconHeight));	
		}
	}
