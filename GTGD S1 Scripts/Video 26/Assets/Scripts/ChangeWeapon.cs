...
/// currently selected weapon.
/// 
/// The FireParticleCannon script accesses this script to determine if it is the 
/// currently selected weapon.
/// 
/// The FireRocket script accesses this script to determine if it is the currently
/// selected weapon.
/// </summary>
